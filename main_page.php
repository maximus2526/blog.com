<?php include 'mysql_manager/db_manage.php'; $conn = connect();?>
    ...
    <div class="content-wrapper">
        ...
        ?>
            ...
            <div class="content-element">
                ...
                <a href="post_page.php?post_id=<?=$row['post_id']?>" class="content-titles"><?=get_attr($conn, "post_title", $row["post_id"]);?></a>
...
<div class="pagination">
    ...
    <button name="page_num" value="<?=$page_num?>" type="submit" class="pagination-btn"><?=$page_num?></button>
